...
a \texttt{LargeInteger} \textcolor{red}{valamivel}\todoref{VALAMIVEL} gyorsabb.
...
így \textcolor{red}{enyhén}\todoref{ENYHÉN} több memóriát is használ.
...
\todoref{LargeInteger: miért nem a BigInt? mérési módsz., JMH, több mérés, memória, optim.}
...
A \regextt{[c]} karakterosztály így mind a három eredeti csomópont gyerekeit átveszi (ezeket esetleg rekurzívan tovább kell bontani).
