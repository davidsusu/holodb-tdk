...
és képezzük rendre a $C_1, C_2, \cdot, C_{n-1}, C_n$ karakterosztályokat úgy,
hogy $C_i = C \textbackslash x$.


A kompakt szófa előállítása nem von maga után exponenciális komplexitást.
Ennek részletes bizonyítását mellőzöm,
de gond nélkül elvégezhető a következő megfontolásokból kiindulva.
A kompakt szófa azokon a helyeken tartalmaz eltéréseket a nyers szófához képest,
ahol több ág közötti összefésülés kezdeményezésére van szükség,
ami egyező prefixű de egymástól különböző részfák esetében fordul elő.
Tehát exponenciálisan ilyen hely kellene szerepeljen a reguláris kifejezés nyers szófájában.
Ahhoz azonban, hogy exponenciálisan sok azonos prefixű hely keletkezzen,
valamilyen elágazások (karakterosztályok vagy alternációk) szekvenciájára van szükég.
Mivel azonban a szekvencia végén ezek a prefixek egy közös ponton találkoznak,
...
amire például ékezetes karakterek vagy kis- és nagybetűk keveredése esetén lehet szükségünk.
