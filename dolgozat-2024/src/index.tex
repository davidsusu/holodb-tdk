...
\begin{tabular}{@{}p{4cm}@{} p{6cm}@{}}
    \textbf{\textit{\small ACM: Classification:}} & \textit{\small Information~systems~/~DBMS~engine architectures} \\
    ~ & \textit{\small Software~and~its~engineering~/~Development~frameworks~and~environments} \\
    ~ & \textit{\small Software~and~its~engineering~/~Software~prototyping}
\end{tabular}
\end{abstract}
