...
\begin{enumerate}
    ...
    \item \textbf{Könnyen és rugalmasan konfigurálható.} Valóban;
          ...
          JPA entitások annotálásán keresztüli beállítás is lehetséges.
    ...
    \item \textbf{Opcionálisan írható.} Valóban;
          ...
          megjegyezve csak a módosításokat.
          Az SQL-futtató rétegbena egy egyszerű tranzakciókezelés
          és a módosító SQL-ek is támogatottak.
\end{enumerate}
