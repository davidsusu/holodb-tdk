...
Összességében az adatbázis minden lényeges eleme állítható a fájlban.
Az adatbázis-séma elemei, megkötései, a táblák általános jellemzői,
az oszlopok értékkészlete, keverési módja és egyéb paraméterei kényelmesen megadhatók.
Értékkészletként előre adott értéklisták vagy akár reguláris kifejezés is használható.
...
A formális specifikáció használata csak egy dedikált, minimalisztikus csomag függőségként való beemelését igényli.
...
Java JPA\todoref{Mi az a JPA?} projekt esetén JPA-entitásokra helyezett annotációkkal is beállítható a teljes konfiguráció,
