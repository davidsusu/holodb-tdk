...
\begin{tabular}{|l||r|r||} 
 \hline
 \multicolumn{1}{|>{\centering\arraybackslash}m{2cm}|}{~}
    & \multicolumn{1}{>{\centering\arraybackslash}m{3cm}|}{\textbf{Standalone}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{3cm}|}{\textbf{Docker}}\\
 \hline\hline
 
 \textbf{H2}         & \texttt{2.2.224} & \texttt{mertcingoz/h2:2.3.232} \\
 \textbf{MariaDB}    & \texttt{10.11.6} (MySQL 15,1) & \texttt{mariadb:10.11.6-jammy} (official) \\
