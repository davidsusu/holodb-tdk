...
\cite{Gao2024FakeDB,SoftwareDatamimic,SoftwarePydbgen,SoftwarePostgresqlFaker}.
...
\begin{tabular}{|l||r|r||} 
 \hline
 \multicolumn{1}{|>{\centering\arraybackslash}m{1.7cm}|}{~}
    & \multicolumn{1}{>{\centering\arraybackslash}m{2.5cm}|}{\begin{tabular}{c} \makebox[0pt]{\footnotesize{\textbf{Docker image}}} \\ (MB) \end{tabular}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{2.5cm}|}{\begin{tabular}{c} \makebox[0pt]{\footnotesize{\textbf{Shadow JAR}}} \\ (MB) \end{tabular}}\\
 \hline\hline
...
\begin{tabular}{|l||r|r||r|r||} 
 ...
 \multicolumn{1}{|>{\centering\arraybackslash}m{1.7cm}|}{~}
    ...
    & \multicolumn{1}{>{\centering\arraybackslash}m{2.5cm}||}{\begin{tabular}{c} \makebox[0pt]{\footnotesize{\textbf{Adatméret}}} \\ (KB) \end{tabular}}\\
 \hline\hline
 
 \textbf{HoloDB}     & 0 s & 280 ms & 1311 bytes & 155848 bytes \\
 \textbf{H2}         & TODO & TODO & TODO &   550 \\
 \textbf{MySQL}      & TODO & TODO & TODO & 2~270 \\
 \hline
