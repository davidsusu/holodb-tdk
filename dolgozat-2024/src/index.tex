...
különféle kényelmi funkciókat is támogat
...
Ilyenek például: automatikus REST API, MongoDB/SPARQL/GraphQL adapter, authentikációs proxy, Apache Calcite\protect\cite{Begoli2018ApacheCalcite,SoftwareApacheCalcite} SQL driver stb.
