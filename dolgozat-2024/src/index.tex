...
\begin{tabular}{|l||r|r|r|r|r|r|r|r||} 
 ...
 \multicolumn{1}{|>{\centering\arraybackslash}m{2cm}|}{~}
    & \multicolumn{4}{>{\centering\arraybackslash}m{1.2cm}|}{\begin{tabular}{c} \small{\textbftt{SMALL}} \\ (ns) \end{tabular}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.2cm}|}{\begin{tabular}{c} \small{\textbftt{LARGE}} \\ (ns) \end{tabular}}
    & \multicolumn{3}{>{\centering\arraybackslash}m{1.2cm}||}{\begin{tabular}{c} \small{\textbftt{MIXED}} \\ (ns) \end{tabular}}\\
 \multicolumn{1}{|>{\centering\arraybackslash}m{2cm}|}{~}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.2cm}|}{\begin{tabular}{c} \small{\textbftt{ADD}} \\ (ns) \end{tabular}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.2cm}|}{\begin{tabular}{c} \small{\textbftt{SIMP}} \\ (ns) \end{tabular}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.2cm}|}{\begin{tabular}{c} \small{\textbftt{NORM}} \\ (ns) \end{tabular}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.2cm}|}{\begin{tabular}{c} \small{\textbftt{POW}} \\ (ns) \end{tabular}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.2cm}|}{\begin{tabular}{c} \small{\textbftt{ADD}} \\ (ns) \end{tabular}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.2cm}|}{\begin{tabular}{c} \small{\textbftt{BOTTL}} \\ (ns) \end{tabular}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.2cm}|}{\begin{tabular}{c} \small{\textbftt{ADD}} \\ (ns) \end{tabular}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.2cm}||}{\begin{tabular}{c} \small{\textbftt{CMPLX}} \\ (ns) \end{tabular}}\\
 \hline\hline
 \textbftt{long}                 & \nodata & \nodata & \nodata &   1,1 & \nodata &    5,3 &   16,7 &   2,6 \\
 \hline\hline
