...
Felmerülhet, hogy miért nem tértem át a \texttt{BigInt} típus használatára.
Ebben a döntésebben az alábbi szempontok játszották a legfőbb szerepet:

\begin{itemize}
    \item A scalás osztályok javában nem idiomatikusak.
          Például beszédes metódusnevek helyett az operátortúlterhelés kódolt neveivel találkozunk
          (\texttt{n.shiftLeft(m)} helyett \texttt{n.\$less\$less(m)} stb.).
    \item A Scala standard könyvtár egy nemkívánatos külső függőséget jelentene,
