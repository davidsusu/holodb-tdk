...
(nagyrészt a scalás Spire matematikai keretrendszer \ŧexttt{SafeLong} osztályát alapul véve%
...
(az egyéb paramétereket lásd az \ref{jmhBenchmarkEnvironment} alfejezetet).
...
\textbf{\textit{A sorok jelentése}}: Lásd a főszöveget.
}
...
indítási idejét\footnote{
  ...
  Ha ezeket a genrálások csak később, on-demand jelleggel futnának,
...
Egy-egy kérés end-to-end feldolgozási ideje az első két SQL esetében kb. 0,25 másodperc volt,
a harmadik kérés esetében akár 4-5 másodpercre is megnyúlt.
A hálózati átvitelen tehát még bőven van fejleszteni való.
