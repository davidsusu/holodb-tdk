...
\usepackage[rightComments=false,italicComments=false]{algpseudocodex}
...
%\renewcommand{\algorithmicfont}{\ttfamily}
%\makeatletter
%\renewcommand{\ALG@beginalgorithmic}{\ttfamily} % Force monospace for the environment
%\makeatother
%\makeatletter
...
A virtuális indexek miatt általában azonban nincs szükség ilyen költséges műveletekre.
...
A tárgyalás során kifejezetten a relációs storage API implementációja lesz a fókuszban,
mint az a szűk keresztmetszet, amely a megoldás újszerűségéhez leginkább hozzájárul,
...
Ezek közül a legegyértelműbbek:

\begin{itemize}
    \setlength\itemsep{-0.4em}
    \item \textbf{Tesztelés:} Integrációs és egyéb tesztek, gyors kipróbálás.
    \item \textbf{Fejlesztés:} Kezdeti fázisban, prototípusoknál, gyakran változó adatszerkezet esetében.
    \item \textbf{Demonstrációk:} Példaadatok bemutatókhoz, koncepciótervekhez.
    \item \textbf{Oktatás:} Ad hoc adathalmaz konkrét példákhoz és feladatokhoz.
\end{itemize}
...
azonnal igazodik a módosításhoz.
...
\begin{enumerate}
    ...
    \item \textbf{Kevés memóriát foglal, az adatokat on-the-fly számítja.} Valóban:
          maguk az adatok egyáltalán nincsenek tárolva, lekérdezéskor kerülnek számításra,ű
