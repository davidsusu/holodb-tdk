...
\begin{tabular}{|l||r|r|r|r|r|r|r|r||} 
 ...
 \rule{0pt}{2.5em}\multicolumn{1}{|>{\centering\arraybackslash}c|}{~}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.2cm}|}{$\sum_{i=1}^{7} a_i$}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.2cm}|}{$\frac{(a+b)c}{d}$}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.2cm}|}{$\left| \frac{e^2}{2}x \right|$}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.2cm}|}{\small{\textbftt{POW}}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.2cm}|}{\small{\textbftt{ADD}}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.2cm}|}{\small{\textbftt{BOTTL}}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.2cm}|}{\small{\textbftt{ADD}}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.2cm}||}{$xxx$}
    \\
...
A második fejlécsorban az elvégzett számítások képletei láthatók.
