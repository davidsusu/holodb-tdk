...
A harmadik teszt (\textbftt{Q-CMPX}) XXXXXXXXXXXXX
...
A negyedik teszt (\textbftt{Q-TFUL}) XXXXXXXXXXXXX
...
Az ötödik teszt (\textbftt{Q-MULT}) XXXXXXXXXXXXX
...
A lekérdezéseket a HoloDB három különböző skálázási szintjén is mértem.
...
mivel ekkor minden egyes visszaadott értéknél el kell végezni a számítást\footnote{
  Ez bizonyos mértékig optimalizálható lennek.
...
A \ref{table:queryComparison} táblázat mutatja a kapott értékeket mikromásodpercben.
