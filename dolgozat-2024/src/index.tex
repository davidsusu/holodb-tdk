...
\begin{tabular}{|l||r|r|r|r|r|r|r|r||} 
 \hline
 \multicolumn{1}{|>{\centering\arraybackslash}m{1.2cm}|}{\multirow{2}{*}{MMM}}
 ...
 \multicolumn{1}{|>{\centering\arraybackslash}c|}{~}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.2cm}|}{$aaa$} % $\[ \sum_{i=1}^{7} a_i \]$
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.2cm}|}{\small{\textbftt{SIMP}}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.2cm}|}{\small{\textbftt{NORM}}}
...
A kisbetűk \texttt{long} értéktartományán belüli,
