...
az Unicode Collation Algorithm (UCA) szabványból érdemes kiindulni.
...
\begin{itemize}
    ...
    \item \textbf{L4}: központozás (Punctuation)
...
ahol minden diakritikus jel, nagybetűsség, központozás stb. eltávolításra került.
...
Ezt a megkötést a UCA kollációi nem biztosítják,
mivel a két utolsó alapértelmezett szint nem pozíciótartó.
Ezért egyelőre csak az első három szintet tartjuk szem előtt
(a központozó karakterek egyszerűen normál alapkaraktereknek számítanak).

\todo[inline]{ALGORITMUS: lekérés a többszintű fából (fa szűkítésével)}

Megjegyzem, az előbbi megkötés áthidalása nem végzetes az eddigi megközelítésünkre.
Ha például a központozó karakterekből álló maximális szubsztringeket
az utánuk következő első normál alapkarakter (illetve a szóvég) diakritikus jeleként értelmezzük,
az egyszerűsítés újra pozíciótartó lesz.
Hasonló érvényes a kódolási variánsokra.

\todo[inline]{megjegyezni a negyedik szint nem is feltétlen hasznos}
% TODO: különösen ha a szóköz is központozásnak számít (vs. szavankénti rendezés),
