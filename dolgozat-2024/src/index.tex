...
ahol a JAR fájlban a Proguard eszközzel kirostáltam a függőségeket nem használt részeit,
illetve egy minimális \texttt{alpine}-alapú Docker-képet használtam minimális Java-telepítéssel.
}
\end{table}
...
a standalone JAR fájl indításával vagy a telepíthető Debian csomag
\texttt{holodb-server} parancsával tudjuk futtatni.

A szerver indításához körülbelül minimum 8MB heap-méretre van szükségünk,
de a használat körülbelül 10MB-nál mondható biztonságosnak.
...
(A részleteket lásd a \ŧexttt{miniconnect-client} project \texttt{README.md} fájljában,
illetve a példaprojektekben.)

Interaktívan csatlakozni a `micl` klienssel lehet
(telepítéshez lásd a \ŧexttt{miniconnect-client} project \texttt{README.md} fájlját).
...
\caption{A MiniConnect REPL használat közben}
\end{figure}
