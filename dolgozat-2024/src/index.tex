...
A dolgozatban szereplő, mikroperformaciára vonatkozó méréseket JMH (\textit{Java Microbenchmark Harness}) keretrendszerben végeztem,
...
egy új műkdési elv a beépített \texttt{BigInt} osztályhoz%
...
A \texttt{BigInt} végülis csak egyetlen osztályt definiál,
...
Az egytelen ezek közül, amit érdemes megemlíteni,
...
\begin{tabular}{|l||r|r|r|r|r|r|r|r||} 
 ...
 \textbftt{LargeInteger}         & \textbf{5,2} & \textbf{5,4} &  \textbf{8,1}\rlap{\footnotemark} &  \textbf{8,1} &          53,8  &          17,3  &         222,7  &         148,2  \\
 \hline
...
\textbftt{MBTL}: $a+X$~;~
\textbftt{MADD}: összetett összeadás overflow-val ~;~
\textbftt{MCALC}: összetett vegyes számítás overflow-val.
A képletekben a kisbetűk \texttt{long} értéktartományán belüli,
a nagybetűk pedig azon kívüli véletlenszámokat jelentenek.
}
\label{table:largeinteger}
\end{table}
\footnotetext{
A \texttt{LargeInteger} valóban a leggyorsabb kis számokon végzett dinamikus hatványozáskor.
Ennek oka, hogy ha a pozitív kitevő 5-nél kisebb, akkor optimalizált szorzást végez.
