...
largeAddition	mixedAddition	mixedBottleneck	smallAddition	mixedNumbers	smallNumbersNormal	smallNumbersPow	smallNumbersSimple



smallAddition  smallNumbersSimple  smallNumbersNormal  smallNumbersPow
largeAddition
mixedBottleneck  mixedAddition  mixedNumbers

\begin{table}
[H]\captionsetup{justification=justified, singlelinecheck=false, margin=0.7cm}
\begin{center}
\begin{tabular}{|l||r|r|r|r|r|r|r|r||} 
 \hline
 \multicolumn{1}{|>{\centering\arraybackslash}m{2cm}|}{~}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.2cm}|}{\begin{tabular}{c} \small{\textbftt{a}} \\ (ns) \end{tabular}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.2cm}|}{\begin{tabular}{c} \small{\textbftt{b}} \\ (ns) \end{tabular}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.2cm}|}{\begin{tabular}{c} \small{\textbftt{c}} \\ (ns) \end{tabular}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.2cm}|}{\begin{tabular}{c} \small{\textbftt{d}} \\ (ns) \end{tabular}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.2cm}|}{\begin{tabular}{c} \small{\textbftt{e}} \\ (ns) \end{tabular}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.2cm}|}{\begin{tabular}{c} \small{\textbftt{f}} \\ (ns) \end{tabular}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.2cm}|}{\begin{tabular}{c} \small{\textbftt{g}} \\ (ns) \end{tabular}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.2cm}||}{\begin{tabular}{c} \small{\textbftt{h}} \\ (ns) \end{tabular}}\\
 \hline\hline
 \textbftt{long}                 & \nodata & \nodata & \nodata &   1,1 & \nodata &    5,3 &   16,7 &   2,6 \\
 \hline\hline
 \textbftt{LargeInteger}         &    53,8 &   222,7 &    17,3 &   5,2 &   148,2 &    8,1 &    8,1 &   5,4 \\
 \hline
 \textbftt{ScalaBigInt}          &    46,0 &   192,8 &    13,7 &   6,0 &   139,1 &   22,3 &   35,6 &   6,9 \\
 \hline
 \textbftt{SafeLong}             &    52,3 &  1002,1 &    16,6 &  12,0 &  1613,2 &   15,0 &   24,6 &   7,3 \\
 \hline
 \textbftt{BigInteger}           &    39,2 &   136,6 &    11,6 &  36,8 &   109,8 &   79,5 &   92,3 &  20,9 \\
 \hline
 \textbftt{Apint}                &   471,4 &  1768,8 &    85,6 & 558,6 &  2274,4 & 2405,7 & 2736,6 & 973,5 \\
 \hline
 ...
 \hline\hline
 \textbftt{LargeInteger}         &   5,2 &   5,4 &    8,1 &    8,1 &    53,8 &    17,3 &   222,7 &   148,2 
 \hline
 \textbftt{ScalaBigInt}          &   6,0 &   6,9 &   22,3 &   35,6 &    46,0 &    13,7 &   192,8 &   139,1 
 \hline
