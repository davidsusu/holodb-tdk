...
\begin{enumerate}
    ...
    \item \textbf{Az adatok könnyen variálhatóak.} Valóban:
          ...
          mely a konfigurációban elhelyezett root seed alapján példányosodik,
    ...
    \item \textbf{Óriás adatmennyiséget is képes szimulálni.} Valóban:
          ...
          az értékkiosztások és más számítások
          a nagy számokat is támogató, kis számokon pedig hatékony beépített aritmetikát használják.
