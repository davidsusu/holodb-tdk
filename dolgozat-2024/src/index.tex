...
Az adatok on-the-fly számításának hatékonnyá tétele érdekében
szükségesnek mutatkozott egy olyan egész típus megalkotása,
mely kis és óriás számokra egyaránt működik,
és a kis számok esetében nagyon hatékony (ellentétben a beépített \texttt{BigInteger} típussal).
