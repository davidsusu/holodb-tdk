...
Egyúttal dupla keresési feltételt is megadok:
...
ám a konfigurációjának méretét,
az indítási idejét\footnote{
...
és a tárhelyigényét összemérhetjük más adatbázisokéval.
...
igénybe vettem néhány bevett extensiont is
(\texttt{postgresql\_anonymizer} \textcolor{red}{(REF)}, \texttt{postgresql\_faker} \textcolor{red}{(REF)}).

Népszerű keretrendszerként a Laravel PHP-keretrendszert választottam.
A Laravel beépített megoldást tartalmaz
az adatmodell leírásához és tesztadatok generálásához \textcolor{red}{(REF)}.
...
Kivétel a Laravel+MySQL/MariaDB a nagyméretű esetben,
...
Kisméretű adathalmaz generálása különböző megoldásokkal. (Összesen néhány ezer rekord.)
}
\end{table}
...
Nagyméretű adathalmaz generálása különböző megoldásokkal. (Több mint tízmillió rekord.)
}
\end{table}
