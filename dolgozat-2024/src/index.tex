...
Architektúra
  ...
  hatékony számítások / segédtípusok / LargeInteger
  írási réteg
  ...
  konfiguráció
...
A virtuális adattár
  ...
  értékkiosztások
  ...
  egyéb értékkiosztásokkal kapcsolatos dolgok
...
KEDD
  fejezet-struktúra
  algoritmusok helyét elkülöníteni
  szövegeket kiigazítani, kiegészíteni
  algoritmusokat implementációnak nekikezdeni
.........................
SZERDA
  algoritmusokat befejezni
  bevezetőt megírni
...
% TODO:
%-------
% H)   1. "A prototípus" és "Konfiguráció" fejezetek taratlmának logikai helyét tisztázni + ténylegesen átrendezni
% H)   2. a nem-bevezetés fejezeteket teljesen teljesen elrendezni
% H)   3. a nem-bevezetés fejezetek szövegeit nagyjából véglegesíteni
% H)   4. az empirikus mérések módszertanáról írni valamit
% K)   5. a bevezető fejezeteket megírni
% K-S) 6. algoritmusok, ha van rá idő
% S)   7. a bírálat alapján újra átnézni az egészet, amit lehet, még javítani, bővíteni
...
\section{(---) A nagy illúzió (RÉGI VERZIÓ VÉGE)}
...
\todo[inline]{A storage API: itt utalni a későbbi kifejtésre}
...
\subsection{(+++) Értékkészlet reguláris kifejezésből}
