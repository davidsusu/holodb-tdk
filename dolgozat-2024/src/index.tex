...
\begin{tabular}{ l l }
        \multicolumn{1}{|>{\centering\arraybackslash}m{3cm}|}{AAAAAAAAAAAAAA} &
        \multicolumn{1}{>{\centering\arraybackslash}m{5cm}|}{{\begin{tabular}{l} BBBBBBBBBBBBBB \\ CCCCCCCCC \\ DDDDDDDDDD \end{tabular}}}} &
\end{tabular}{ l l }

\textit{(ACM: Classification: Information~systems~/~DBMS~engine architectures, Software~and~its~engineering~/~Development~frameworks~and~environments, Software~and~its~engineering~/~Software~prototyping)}
\end{abstract}
