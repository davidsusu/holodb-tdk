...
(az egyéb paramétereket lásd a \ref{jmhBenchmarkEnvironment} szekcióban).
...
\begin{tabular}{|l||l|l||} 
 ...
 \multicolumn{1}{|>{\centering\arraybackslash}m{3cm}|}{~}
    & \multicolumn{1}{>{\centering\arraybackslash}m{5cm}|}{\textbf{Standalone}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{5cm}|}{\textbf{Docker}}\\
 \hline\hline
 
 \textbf{H2}         & \texttt{2.2.224} & \texttt{mertcingoz/h2:2.3.232} \\
 \textbf{MariaDB}    & \texttt{10.11.6} () & \texttt{mariadb:10.11.6-jammy} (official) \\
...
5 különböző bonyolultságú és válaszméretű fix lekérést mértem,
