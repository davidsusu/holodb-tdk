...
\begin{tabular}{|l||r|r|r|r|r|r|r|r||} 
 ...
 \rule{0pt}{2.5em}\multicolumn{1}{|>{\centering\arraybackslash}c|}{~}
...
\textbftt{SNORM}: összetett számítás aritmetikai műveletekkel és bitmanipulációval ~;~
\textbftt{SPOW}: összetett számítás aritmetikai műveletekkel, bitszintű műveletekkel és hatványozással~;~
\textbftt{LADD}:  $\sum_{i=1}^{5} X_i$~;~
\textbftt{MBTL}: $a+X$~;~
\textbftt{MADD}: összetett összeadás overflow-kkal ~;~
\textbftt{MCALC}: összetett vegyes számítás overflow-val.
\parA képletekben a kisbetűk \texttt{long} értéktartományán belüli,
a nagybetűk pedig azon kívüli számokat jelentenek
(megfelelő paraméterekkel, véletlenszerűen választva).
}
