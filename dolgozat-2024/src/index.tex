...
\multicolumn{1}{|>{\centering\arraybackslash}m{2cm}|}{~}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.4cm}|}{\begin{tabular}{c} \small{\textbftt{a}} \\ (ns) \end{tabular}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.4cm}|}{\begin{tabular}{c} \small{\textbftt{b}} \\ (ns) \end{tabular}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.4cm}|}{\begin{tabular}{c} \small{\textbftt{c}} \\ (ns) \end{tabular}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.4cm}|}{\begin{tabular}{c} \small{\textbftt{d}} \\ (ns) \end{tabular}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.4cm}|}{\begin{tabular}{c} \small{\textbftt{e}} \\ (ns) \end{tabular}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.4cm}|}{\begin{tabular}{c} \small{\textbftt{f}} \\ (ns) \end{tabular}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.4cm}|}{\begin{tabular}{c} \small{\textbftt{g}} \\ (ns) \end{tabular}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.4cm}||}{\begin{tabular}{c} \small{\textbftt{h}} \\ (ns) \end{tabular}}\\
 \hline\hline
 \textbftt{long}                 &  \nodata  &  \nodata  &  \nodata  &   1,1  &  \nodata  &   5,3  &  16,7  &   2,6  \\
 \hhline{|=|=|=|=|=|=|=|=|=|}
