...
Az ilyen nomálalak karakterenkénti rendezése problémamentes:

\begin{itemize}
    \item egy előbbi komponenshez tartozó karakter mindig megelőzi a későbbit.
    \item az alapkaraterek rendezése egymáshoz képest: 
\end{itemize}
...
\todo[inline]{továbbfejlesztés: az UCA még részletesebb és konfigurálható megvalósítása}
