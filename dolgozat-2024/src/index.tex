...
Például a \texttt{([a-c]z(tt|uu)|a[s-z])} reguláris kifejezés nyers szófája így néz ki:
...
\begin{itemize}
    \item a lista opcionális első eleme a szóvég csomópont, ami kötelező, ha nincs más a listában
    \item a lista elemei ezen kívül diszjunkt karakterosztályok
    \item bármely karakterosztály listaelem minden tartalmazott karaktere későbbi, mint bármely megelőző karakterosztály elem bármely tartalmazott karaktere
\end{itemize}
...
A \texttt{([a-c]z(tt|uu)|a[s-z])} reguláris kifejezés fenti nyers szófájából
...
\todo[inline]{kompakt szófa előállítása a reguláris kifejezésből lineáris tárhely- és időigényű}
...
mint az átementi üres csomópontokat, tehát elimináljuk és megjegyezzük őket,
