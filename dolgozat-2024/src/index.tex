...
\textcolor{red}{MEGÍRNI, összehasonlítás}\todoref{MEGÍRNI: Lekérdezések sebessége}


\section{Általános jellemzők}

\textcolor{red}{MEGÍRNI}\todoref{MEGÍRNI: Általános jellemzők}
...
\todoref{Mérések részletei, pontos paraméterek, docker build stb.}
...
\begin{tabular}{|l||r|r|r|r|r||r|r|r||} 
 \hline
 \multicolumn{1}{|>{\centering\arraybackslash}m{1.2cm}|}{\multirow{2}{*}{~}}
    & \multicolumn{5}{>{\centering\arraybackslash}c|}{\textbftt{QUERY}}
    & \multicolumn{3}{>{\centering\arraybackslash}c||}{\textbftt{WEB}}
    \\
 \cline{2-9}
 ...
 \textbf{HoloDB/}\textbftt{EXT} & 43,00 & 180,35 & 1~981,98 & 1~514~177 & 6~818 & 6,79 & 7,10 & 12,16 \\
 \textbf{HoloDB/}\textbftt{DEF} & 24,66 & 130,08 &   225,17 & 1~143~721 & 3~592 & 6,36 & 6,56 & 11,09 \\
 \textbf{HoloDB/}\textbftt{MIN} & 22,82 &  20,22 &    44,58 &    25~909 &   365 & 4,60 & 4,76 &  7,54 \\
 \textbf{H2}                    & 12,77 &   9,73 &    17,60 &     1~965 &   177 & 3,92 & 4,02 &  6,07 \\
 \textbf{MySQL}                 & 47,87 &  46,27 &    73,02 &     3~393 & 1~429 & 5,10 & 5,43 &  8,38 \\
 \hline
...
\begin{tabular}{|l|l||r|r||r|r||} 
 \hline
 \multicolumn{1}{|>{\centering\arraybackslash}m{1.7cm}|}{~}
    & \multicolumn{1}{>{\centering\arraybackslash}m{2.5cm}||}{\begin{tabular}{c} \makebox[0pt]{\footnotesize{\textbf{Generátor}}} \\ (s) \end{tabular}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{2.5cm}|}{\begin{tabular}{c} \makebox[0pt]{\footnotesize{\textbf{Generálás}}} \\ (s) \end{tabular}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{2.5cm}||}{\begin{tabular}{c} \makebox[0pt]{\footnotesize{\textbf{Indítás}}} \\ (ms) \end{tabular}}
 ...
 \textbf{MySQL}      & Laravel & 7,08 & 0,28 & 7~944 & 0,45 \\
 \textbf{Postgres}   &     SQL & 0,20 & 2,25 & 2~005 & 1,40 \\
 \hline
...
\begin{tabular}{|l|l||r|r||r|r||} 
 ...
 \textbf{MySQL}      & Laravel & 15~734 & 0,30 & 8~008 & 1~101,47 \\
 \textbf{Postgres}   &     SQL &     95 & 2,26 & 2~017 & 1~409,57 \\
 \hline
...
\todoref{Célkitűzések teljesülését a mérések alapján kiegészíteni}


\section{Tervek a közeljövőre}

\todoref{Tervek: kérdőíves kut., MongoDB/SPARQL/GraphQL, migr. keretr.}
...
\todoref{Algoritmusokat ebben a formában teljesen kivenni}
