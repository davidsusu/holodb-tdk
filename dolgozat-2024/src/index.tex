...
Ilyenek például: automatikus REST API, NoSQL adapterek (MongoDB, SPARQL, GraphQL), authentikációs proxy, Apache Calcite\protect\cite{Begoli2018ApacheCalcite,SoftwareApacheCalcite} SQL driver stb.
...
egyelőre elsősorban az elméleti lehetőségre kívántam rámutatni.
...
\todoref{+TERVEK: kérdőíves kutatás}
\todoref{+TERVEK: MongoDB/SPARQL/GraphQL}
