...
mindig a megfelelő módon egyszerűen bővtsük, amikor szükséges.
A helyzet azonban valamivel komplikáltabb.
Előfordulhat, hogy egy oszlopból már értékeket kellett visszaadnunk,
mielőtt beérkezett volna egy olyan kérés, mely az oszlop típusát egyértelművé tette,
mégpedig másként, mint ahogy korábban döntöttünk.
Vagy az is előfordulhat, hogy az összes oszlop tartalma (wildcard) vagy a tábla szerkezete kerül lekérésre,
pedig később még további oszlopokról is érkezik információ.
Vagy eleve megpróbáljuk elkerülni ezeket az eseteket,
vagy megadunk egy stratégiát a kezelésükre.
Továbbá mindkét esetben vagy ragaszkodunk a koherenciához, vagy nem.

(Az összes oszlop lekérését igénylő esetekkel most nem foglalkozom,
szerintem a legjobb ilyenkor egyszerűen a már felvett oszlopokat visszaadni,
vagy egy alapértelmezett táblaszerkezetet, ha addig a tábla még nem lett létrehozva.)
...
Minden lekérést igyekszünk a kéréshez legjobban igazodó adatszerkezettel kiszolgálni,
...
akár úgy, hogy a nem változó oszlopok módosításait megtartjuk.
