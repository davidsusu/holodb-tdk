...
\subsection{VIRTUÁLISÉRTÉKKÉSZLETEK}
...
\todo[inline]{nem kereshető: random reverse regex generátor beépítése}

\todo[inline]{trie használata: nem nagyon bonyolult}

\todo[inline]{az előbbi általánosítása a háromszintű rendezéshez}
