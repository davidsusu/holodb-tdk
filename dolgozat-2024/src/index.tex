...
Az ehhez hasonló konfigurációk szerencsére meglehetősen életszerűtelennek tűnnek.
...
\begin{itemize}
    \item \textbf{L1}: alapkaraterek (Base characters)
...
% TODO: itt rögtön rátérhetünk a megvalósításra
