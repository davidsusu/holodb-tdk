...
Az adatbázishoz interaktívan csatlakozni a `micl` klienssel lehet
...
Ehhez Gradle vagy Maven projekt esetén
a \texttt{hu.webarticum.holodb:embedded:\$\{holodbVersion\}} függőség beállítása szükséges.
A JDBC URL
