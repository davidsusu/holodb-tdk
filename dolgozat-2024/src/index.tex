...
A pályamunka fő célja, hogy igazolja: a koncepció alapvetően működik.
...
Így a felvonultatott mérési eredmények is az átfogó működőképesség
alátámasztására szolgálnak, számszerűsített formában.
...
az egyes részproblémák önálló aprólékos elemzésére.
...
\begin{itemize}
    ...
    \item Debian 12, OpenJDK 17.0.13
...
\begin{tabular}{|l|r|} 
 \hline
 \multicolumn{1}{|>{\centering\arraybackslash}m{7cm}|}{\textbf{Esemény}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{2.5cm}|}{\begin{tabular}{c} \textbf{Időpont} \\ (ns) \end{tabular}}\\
 \hline\hline
 \textbf{Indítási parancs} & 0 \\
 \textbf{Ready} & 1~234 \\
 \textbf{Parancs kiadása} & 1~234 \\
 \textbf{Parancs beérkezése} & 1~234 \\
 \textbf{Futtatás vége} & 1~234 \\
 \textbf{...} & 1~234 \\
 \textbf{Feldolgozás vége} & 1~234 \\
 \hline
\end{tabular}
\end{center}
\caption[HoloDB futtatás timeline]{
HoloDB futtatás timeline.
}
\end{table}
...
(ezeknél a méréseknél itt nem használtam JMH-t).
...
% https://hub.docker.com/layers/mertcingoz/h2/2.3.232/images/sha256-52b7f6aa8138592c95830a127ac14694ef3fff221a31210a828ca39f00b958de
% https://hub.docker.com/layers/jochenwierum/openjdk-minimal-jre/17.0.7/images/sha256-978c2b61ab2d04b20c8e4260daa299bec65cab5254e8ad0891bdc47de89cf766
...
\begin{tabular}{|l||r|r|r|r|r||} 
 ...
 \textbf{MySQL}                 & 47,87 &  46,27 &    73,02 &     3~393 & 1~429 \\
 \hline
...
\begin{tabular}{|l||r|r|r||} 
 \hline
 \multicolumn{1}{|>{\centering\arraybackslash}m{1.7cm}|}{~}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.3cm}|}{\begin{tabular}{c} \makebox[0pt]{\footnotesize{\textbftt{RO-SIMP}}} \\ (s) \end{tabular}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.3cm}|}{\begin{tabular}{c} \makebox[0pt]{\footnotesize{\textbftt{RO-CMPX}}} \\ (s) \end{tabular}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{1.3cm}||}{\begin{tabular}{c} \makebox[0pt]{\footnotesize{\textbftt{WR-CMPX}}} \\ (s) \end{tabular}}\\
 \hline\hline
...
\textbf{\textit{A sorok jelentése}}: Lásd: ...
}
\end{table}
...
TODO: az oszlopok lazy inicializálása jelentősen csökkentheti az indítási időt


Konfiguráció:
HoloDB: N/A;
Postgres: SQL szkript;
Mysql+Laravel: factory + seeder;
...
\begin{tabular}{|l|l||r|r||r|r||} 
 \hline
 \multicolumn{1}{|>{\centering\arraybackslash}m{1.7cm}|}{~}
    & \multicolumn{1}{>{\centering\arraybackslash}m{2.5cm}||}{\textbf{Generátor}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{2.5cm}|}{\begin{tabular}{c} \makebox[0pt]{\footnotesize{\textbf{Generálás}}} \\ (s) \end{tabular}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{2.5cm}||}{\begin{tabular}{c} \makebox[0pt]{\footnotesize{\textbf{Indítás}}} \\ (s) \end{tabular}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{2.5cm}|}{\begin{tabular}{c} \makebox[0pt]{\footnotesize{\textbf{Konfiguráció}}} \\ (B) \end{tabular}}
    & \multicolumn{1}{>{\centering\arraybackslash}m{2.5cm}||}{\begin{tabular}{c} \makebox[0pt]{\footnotesize{\textbf{Tárigény}}} \\ (MiB) \end{tabular}}\\
 \hline\hline
 
 \textbf{HoloDB}     & \nodata        & 0,00 & 0,28 & 1~303 & 0.16 \\
 \textbf{MySQL}      & Laravel seeder & 7,08 & 0,28 & 7~944 & 0,45 \\
 \textbf{Postgres}   & SQL-szkript    & 0,20 & 2,25 & 2~005 & 1,40 \\
 \hline

\end{tabular}
\end{center}
\caption[GEN1]{~200 + 2~000 + 5~000 ::: 100 futtatás}
\end{table}
...
\begin{tabular}{|l|l||r|r||r|r||} 
 ...
 \textbf{MySQL}      & Laravel seeder & 15~734 & 0,30 & 8~008 & 1~101,47 \\
 \textbf{Postgres}   & SQL-szkript    &     95 & 2,26 & 2~017 & 1~409,57 \\
 \hline

\end{tabular}
\end{center}
\caption[GEN2]{~2000 + 1~000~000 + 10~000~000 ::: 10 futtatás, kivéve MySQL+Laravel, ott 3}
\end{table}
...
\begin{enumerate}
    ...
    \item \textbf{Az adatok könnyen variálhatóak.} Valóban;
          ...
          így a root seed módosításával a teljes adatbázis megváltozik.
