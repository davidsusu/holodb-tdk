...
(\texttt{postgresql\_anonymizer} \textcolor{red}{(R)}, \texttt{postgresql\_faker} \textcolor{red}{(R)}).

Népszerű keretrendszerként a Laravel PHP-keretrendszert választottam.
A Laravel beépített megoldást tartalmaz
az adatmodell leírásához és tesztadatok generálásához \textcolor{red}{(R)}.
