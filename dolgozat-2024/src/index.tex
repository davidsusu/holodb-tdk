...
A legtöbb szoftver architektúrájában elkülöníthető valamilyen fokális entitástípus,
mely alapvető szerepet tölt be (például egy könyvtári katalógusban a \textit{könyv}).
