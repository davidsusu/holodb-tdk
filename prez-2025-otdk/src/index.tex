...
\begin{frame}[t,fragile]
    ...
    \begin{minipage}[t]{0.6\textwidth}
        ...
        ~
            ...
            & \begin{tabular}{c} \footnotesize{\textbftt{paq8/4}} \\ (\%) \end{tabular}
            & \begin{tabular}{c} \small{\textbftt{create}} \\ (ns) \end{tabular}
            & \begin{tabular}{c} \small{\textbftt{at×30}} \\ (ns) \end{tabular}\\
        \hline\hline
