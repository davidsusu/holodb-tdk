...
\begin{frame}[t,fragile]
    ...
    \begin{minipage}[t]{0.4\textwidth}
        ...
        {\color{beamer@blendedblue}Permutációkra vonatkozó elvárások}
    ...
    \begin{minipage}[t]{0.6\textwidth}
        ...
        \hline
        \textbftt{MP1}         &     152 &  0,19 & 267 &    161 \\
        \hline
        \textbftt{FEI-F-4}     &     608 & 19,56 & 660 &  8~800 \\
        \hline
        \textbftt{FEI-S-2}     & 212~312 & 97,08 & 434 & 32~221 \\
        \hline
        \textbftt{FPE1}        & 211~352 & 97,07 & 540 & 67~155 \\
        \hline
        \end{tabular}
        ...
        \begin{minipage}[b]{0.25\textwidth}
            \centering
            \includegraphics[width=0.9\textwidth]{image/permutation-fav.png}
            \par FAV
        \end{minipage}%
        \begin{minipage}[b]{0.25\textwidth}
            \centering
        ...
        \begin{minipage}[b]{0.25\textwidth}
            \centering
            \includegraphics[width=0.9\textwidth]{image/permutation-feif4.png}
            \par FEI-F-4
        \end{minipage}%
        \begin{minipage}[b]{0.25\textwidth}
            \centering
