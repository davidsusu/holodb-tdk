...
\begin{frame}
    ...
    \begin{minipage}[c]{0.47\textwidth}
        ...
        \mintinline{sql}{SELECT firstname FROM students WHERE id = 30}
        
        \vspace{0.2em}
        
        \makebox[3em][l]{\textbftt{Q-REC}:} dolor sit amet
        \mintinline{sql}{SELECT * FROM students WHERE id = 30}
        
        \vspace{0.2em}
        
        \makebox[3em][l]{\textbftt{Q-TFUL}:} asdf fdsa
        \mintinline{sql}{SELECT * FROM students}
    \end{minipage}
    \hspace*{\fill}%
    \begin{minipage}[c]{0.47\textwidth}
        \textbftt{Q-MULT}: LOREM IPSUM
    \end{minipage}
    \hspace*{\fill}%
\end{frame}
