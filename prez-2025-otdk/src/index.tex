...
\begin{frame}[t,fragile]
    ...
    \begin{minipage}[t]{0.6\textwidth}
        ...
        \hline
        ~
            & \begin{tabular}{c} \small{\textbftt{mem}} \\ \small{(bytes)} \end{tabular}
            & \begin{tabular}{c} \small{\textbftt{paq8/4}} \\ \small{(\%)} \end{tabular}
            & \begin{tabular}{c} \small{\textbftt{create}} \\ \small{(ns)} \end{tabular}
            & \begin{tabular}{c} \small{\textbftt{at×30}} \\ \small{(ns)} \end{tabular}\\
        \hline\hline
