...
\begin{frame}[t,fragile]
    ...
    \begin{minipage}[t]{0.4\textwidth}
        ...
        \begin{itemize}
            ...
            \item látszólagos véletlenszerűség
    ...
    \begin{minipage}[t]{0.6\textwidth}
        ...
        \hline
        ~
            & \begin{tabular}{c} \small{\textbftt{mem}} \\ \footnotesize{(bytes)} \end{tabular}
            & \begin{tabular}{c} \small{\textbftt{paq8/4}} \\ \footnotesize{(\%)} \end{tabular}
            & \begin{tabular}{c} \small{\textbftt{create}} \\ \footnotesize{(ns)} \end{tabular}
            & \begin{tabular}{c} \small{\textbftt{at×30}} \\ \footnotesize{(ns)} \end{tabular}\\
        \hline\hline
