...
\begin{frame}[fragile]
    ...
    \hspace*{\fill}%
    \begin{minipage}[c]{0.47\textwidth}
        \makebox[3em][l]{\textbftt{Q-FLD}:}
        {\footnotesize{\mintinline{sql}{SELECT fn FROM students WHERE id=30}}}
        
        \vspace{0.2em}
        
        \makebox[3em][l]{\textbftt{Q-REC}:}
        {\footnotesize{\mintinline{sql}{SELECT * FROM students WHERE id=30}}}
        
        \vspace{0.2em}
        
        \makebox[3em][l]{\textbftt{Q-TFUL}:}
        {\footnotesize{\mintinline{sql}{SELECT * FROM students}}}
    \end{minipage}
    \hspace*{\fill}%
    \begin{minipage}[c]{0.47\textwidth}
        \textbftt{Q-MULT}:
...
\begin{frame}
    ...
    \hspace*{\fill}%
    \begin{minipage}[c]{0.29\textwidth}
        \includesvg[width=\0.9textwidth]{image/planning}
    \end{minipage}
    \hspace*{\fill}%
\end{frame}
