...
\begin{frame}[fragile]
    ...
    \begin{minipage}[c]{0.35\textwidth}
        ...
        \begin{minipage}[t]{0.48\textwidth}
            ...
            \includegraphics[width=0.7\textwidth, frame]{image/mostly-ai}\par
            \textbf{MOSTLY AI}
            
            \includegraphics[width=0.7\textwidth, frame]{image/tonic}\par
            \textbf{Tonic}
        \end{minipage}%
        \hspace*{\fill}%
        \begin{minipage}[t]{0.48\textwidth}
            ...
            \includegraphics[width=0.7\textwidth, frame]{image/genrocket}\par
            \textbf{GenRocket}
            
            \includegraphics[width=0.7\textwidth, frame]{image/delphix}\par
            \textbf{Delphix}
        \end{minipage}%
        ...
        \includegraphics[width=0.7\textwidth, frame]{image/faker}\par
        \textbf{Faker}
