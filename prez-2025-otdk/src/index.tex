...
\begin{frame}[fragile]
    ...
    \begin{minipage}[c]{0.35\textwidth}
        ...
        \begin{minipage}[t]{0.48\textwidth}
            ...
            \includegraphics[width=0.47\textwidth, frame]{image/mostly-ai}\par
            \textbf{MOSTLY AI}
            
            \vspace{5pt}
            
            \includegraphics[width=0.47\textwidth, frame]{image/tonic}\par
            \textbf{Tonic}
        \end{minipage}%
        \hspace*{\fill}%
        \begin{minipage}[t]{0.48\textwidth}
            ...
            \includegraphics[width=0.47\textwidth, frame]{image/genrocket}\par
            \textbf{GenRocket}
            
            \vspace{5pt}
            
            \includegraphics[width=0.47\textwidth, frame]{image/delphix}\par
            \textbf{Delphix}
        \end{minipage}%
        \hspace*{\fill}%
...
\begin{frame}
    \slidetitle{\sectionshorttitle}{XXXXXXXXX}
    ...
    \begin{minipage}[c]{0.35cm}
        \begin{overprint}
            ...
            \onslide<2-3>\centerline{\includegraphics[height=0.85\textheight]{diagram/simplearch-1}}
        \end{overprint}
    \end{minipage}%
    \hspace*{\fill}
    \begin{minipage}[c]{0.3\textwidth}
        \begin{overprint}
            \onslide<2-3>\begin{itemize}
                ...
                \item {\only<3>{\color{beamer@blendedblue}}\texttt{Source}}
                \item \texttt{Row}
    ...
    \begin{minipage}[c]{0.3\textwidth}
        \begin{overprint}
            \onslide<3>\centerline{\includegraphics[width=0.9\textwidth]{diagram/storage-source}}
        \end{overprint}
    \end{minipage}%
    \hspace*{\fill}%
\end{frame}
