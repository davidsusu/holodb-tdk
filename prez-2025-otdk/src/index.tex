...
\begin{frame}[fragile]
    ...
    \begin{minipage}[c]{0.35\textwidth}
        ...
        \begin{columns}[t]
            \column{.5\textwidth}
            \includegraphics[width=0.7\linewidth, frame]{image/mostly-ai}
            \includegraphics[width=0.7\linewidth, frame]{image/tonic}
            \column{.5\textwidth}
            \includegraphics[width=0.7\linewidth, frame]{image/genrocket}
            \includegraphics[width=0.7\linewidth, frame]{image/delphix}
        \end{columns}
        ...
        \includegraphics[width=0.7\linewidth, frame]{image/faker}
