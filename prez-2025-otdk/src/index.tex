...
\begin{frame}[t,noframenumbering,fragile]
    ...
    \begin{itemize}
        \setlength\itemsep{1em}
        \item JPA entitásokból \textbf{jelenleg is konfigurálható} (opcionális kiegészítő annotációkkal):
    \end{itemize}
...
\begin{frame}[t,noframenumbering]
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item jelenleg csak részhalmaz megkötés (pl. idegen kulcs) konfigurálható
        ...
        \end{itemize}
        \item "kombinatorikus" virtuális index tervezés alatt
        \item komplexebb kényszerek konfigurálhatósága tervezés alatt
    \end{itemize}
