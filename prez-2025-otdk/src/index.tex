...
\begin{frame}
    ...
    \hspace*{\fill}%
    \begin{minipage}[t]{0.47\textwidth}\begin{tabular*}{\textwidth}{@{}l@{\hskip 1em}l@{}}
        \textbftt{Q-FLD}: & Lorem ipsum \\
        \textbftt{Q-REC}: & dolor sit amet \\
        \textbftt{Q-TFUL}: & asdf fdsa \\
        \end{tabular*}
    \end{minipage}
    \hspace*{\fill}%
    \begin{minipage}[t]{0.47\textwidth}
        \textbftt{Q-MULT}: adkfjaldsfja skdfjl
    \end{minipage}
    \hspace*{\fill}%
\end{frame}
