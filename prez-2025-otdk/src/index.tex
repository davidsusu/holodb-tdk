...
\begin{frame}[fragile]
    ...
    \begin{minipage}[c]{0.35\textwidth}
        ...
        \begin{columns}[t]
            \column{.5\textwidth}
            \includegraphics[width=\linewidth, frame]{image/mostlí-ai}
            \includegraphics[width=\linewidth, frame]{image/tonic}
            \column{.5\textwidth}
            \includegraphics[width=\linewidth, frame]{image/genrocket}
            \includegraphics[width=\linewidth, frame]{image/delphix}
        \end{columns}
