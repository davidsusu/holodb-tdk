...
\section{A létező megközelítések}
...
\begin{frame}
    ...
    \begin{overprint}
        \onslide<1>\centerline{\includegraphics[height=0.7\textheight]{diagram/findvalue-0}}
        \onslide<2>\centerline{\includegraphics[height=0.7\textheight]{diagram/findvalue2-1}}
        \onslide<3>\centerline{\includegraphics[height=0.7\textheight]{diagram/findvalue2-2}}
    \end{overprint}
...
\begin{frame}
    ...
    \begin{overprint}
        \onslide<1>\centerline{\includegraphics[height=0.7\textheight]{diagram/findvalue-0}}
        \onslide<2>\centerline{\includegraphics[height=0.7\textheight]{diagram/findvaluenone-1}}
        \onslide<3>\centerline{\includegraphics[height=0.7\textheight]{diagram/findvaluenone-2}}
    \end{overprint}
...
\begin{frame}
    ...
    \begin{minipage}[c]{0.19\textwidth}
        \scalebox{1.3}{\qrcode{https://github.com/miniconnect/holodb}}
    \end{minipage}%
\end{frame}
