...
\begin{frame}
    \slidetitle{\sectionshorttitle}{XXXXXXXXXX}
    ...
    ~
        ...
        & \begin{tabular}{c} \textbftt{Q-CMPX} \\ ({\textmu}s) \end{tabular}
        & \begin{tabular}{c} \textbftt{Q-TFUL} \\ ({\textmu}s) \end{tabular}
        & \begin{tabular}{c} \textbftt{Q-MULT} \\ ({\textmu}s) \end{tabular}\\
    \hline\hline

    \textbf{HoloDB/}\textbftt{EXT} & 43,00 & 180,35 & \bad{1~981,98} & \bad{1~514~177} & \bad{6~818} \\
    \textbf{HoloDB/}\textbftt{DEF} & 24,66 & 130,08 & 225,17 & \bad{1~143~721} & \bad{3~592 \\
    \textbf{HoloDB/}\textbftt{MIN} & 22,82 & 20,22 & 44,58 & 25~909 & 365 \\
    \textbf{H2}& \best{12,77} & \best{9,73} & \best{17,60} & \best{1~965} & \best{177} \\
...
\begin{frame}
    ...
    \hline
    ~
        & \begin{tabular}{c} \makebox[0pt]{\footnotesize{\textbftt{RO-SIMP}}} \\ (s) \end{tabular}
        & \begin{tabular}{c} \makebox[0pt]{\footnotesize{\textbftt{RO-CMPX}}} \\ (s) \end{tabular}
        & \begin{tabular}{c} \makebox[0pt]{\footnotesize{\textbftt{WR-CMPX}}} \\ (s) \end{tabular}\\
    \hline\hline
