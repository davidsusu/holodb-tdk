...
\begin{frame}
    ...
    \begin{itemize}
        \setlength\itemsep{1em}
        \pause \item további értékkészlet-típusok
        \pause \item könnyen konfigurálható megkötések
        \pause \item DBeaver-integráció
        \pause \item HoloDB mint felhőszolgáltatás
    \end{itemize}
\end{frame}
