...
\begin{frame}
    ...
    ~
        & \textbf{Generátor}
        & \begin{tabular}{c} \makebox[0pt]{\footnotesize{\textbf{Generálás}} \\ (s) \end{tabular}}
        & \begin{tabular}{c} \makebox[0pt]{\footnotesize{\textbf{Indítás}} \\ (s) \end{tabular}}
        & \begin{tabular}{c} \makebox[0pt]{\footnotesize{\textbf{Konfiguráció}} \\ (B) \end{tabular}
        & \begin{tabular}{c} \makebox[0pt]{\footnotesize{\textbf{Tárigény}}} \\ (MiB) \end{tabular}\\
    \hline\hline
