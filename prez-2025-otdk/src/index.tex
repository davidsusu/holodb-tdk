...
\begin{frame}[fragile]
    ...
    \begin{minipage}[c]{0.52\textwidth}
        \makebox[3.5em][l]{\small{\small{\textbftt{Q-FLD}:}}
        {\scriptsize{\mintinline{sql}{SELECT fn FROM students WHERE id=30}}}
        
        \vspace{0.8em}
        
        \makebox[3.5em][l]{\small{\textbftt{Q-REC}:}}
        {\scriptsize{\mintinline{sql}{SELECT * FROM students WHERE id=30}}}
        
        \vspace{0.8em}
        
        \makebox[3.5em][l]{\small{\textbftt{Q-TFUL}:}}
