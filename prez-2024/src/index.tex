...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item {\color{red}JPA} entitásokra helyezett annotációkkal is definiálható
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item JPA-entitásokból is indítható
...
\begin{frame}
    ...
    \begin{itemize}
        \setlength\itemsep{1em}
        \item több és részletesebb mérési eredmény
...
\begin{frame}[t,noframenumbering]
    ...
    \begin{itemize}
        ...
        \item nem csak fejlesztéskor van szükség átemeneti adatbázisra
...
\begin{frame}[t,noframenumbering]
    ...
    \begin{itemize}
        \setlength\itemsep{1em}
        \item már dolgoztam a LargeInteger-en, mikor a BigInt a scala API-ba került
