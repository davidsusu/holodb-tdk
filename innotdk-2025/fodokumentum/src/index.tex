...
A HoloDB egy Java nyelven írt általános célú adatbázismockoló, illetve -szimuláló eszköz, mely egy valószerű adatokkal feltöltött, ténylegesen funkcionáló relációs adatbázist képét nyújtja, pusztán egy tömör, deklaratív konfiguráció alapján.
...
A HoloDB körül folyamatban van egy gazdag eszközinfrastruktúra kiépítése, magába foglalva többek között a következőket: felhasználóbarát parancssori REPL, adatbázisböngészők támogatása (DBeaver), NoSQL adapterek (például MongoDB, GraphQL, SPARQL), GraalVM-támogatás stb.
...
a konfiguráció bővítése és egyértelműsége,
