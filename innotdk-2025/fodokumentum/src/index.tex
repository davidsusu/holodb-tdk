...
Hozzáférhetővé kell tenni továbbá a valamely elterjedt grafikus adatbázis-böngészővel (például DBeaver),
és indíthatóvá tenni egy elterjedt adatbázis-tervező eszközből (például ).
}
