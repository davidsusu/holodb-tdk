...
A HoloDB nyílt forráskódú projektként elérhető (\url{https://github.com/miniconnect/holodb}).
...
Ha a keretek engedik, egyúttal szeretném felmérni a fejlesztők, technológiai vezetők véleményét az ötlet alkalmazhatóságáról a gyakorlatban.
Ez részben kérdőíves formában is történhet, de valós projektekben való kipróbálás keretében is, ami összekapcsolható az 1. pontban említett validációval.
