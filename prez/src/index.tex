...
\begin{frame}
    ...
    \pause Lényegileg a \texttt{Random} hierarchikus változata.
    
    \vspace{0.2cm}
    
    \begin{itemize}
        \pause \item egyenlő példány mindig ugyanazt a (végtelen) bitsorozatot szolgáltatja
        \pause \item egy kulcs megadásával alpéldányt gyárt (eggyel alacsonyabb szint)
        \pause \item ugyanazzal a kulcs bájtsorozattal egyenlő példányt ad vissza
    \end{itemize}

    \vspace{0.7cm}
    
    \pause Gyenge követelmények:

    \vspace{0.2cm}
    
    \begin{itemize}
        \pause \item véletlenszerű kimenetet ad
        \pause \item eltérő példányoknál jellemzően független, különböző kimenetet ad
    \end{itemize}
...
\begin{frame}
    ...
    \begin{itemize}
        \setlength\itemsep{0.5em}
        \pause \item ebben a szcenárióban elengedjük a kis tárhelyigényt
        \pause \item az összes létező címet fogjuk leképezni a táblára
        \pause \item szolgáltatunk egy többoszlopos (leftmost prefix) indexet
        \pause \item alternatív index: implicite üres kerülettel
        \pause \item a vármegyét, irányítószámot és egyéb adatokat származtatjuk
        \pause \item utóbbiak a hierarchia különböző szintjeihez tartozhatnak
    \end{itemize}
\end{frame}
