...
\begin{frame}
    ...
    %TODO: Visszatérő nehézségek: Ide is képeket, könnyebben felfoghatóra
...
\begin{frame}
    ...
    \begin{logolist}
        ...
        \item[{\includegraphics[width=2em,height=2em]{image/mostly-ai.png}}]
            ...
            \end{minipage}
        \item[{\includegraphics[width=2em,height=2em]{image/tonic.png}}]
            ...
            \end{minipage}
        \item[{\includegraphics[width=2em,height=2em]{image/genrocket.png}}]
            \begin{minipage}[c]{\linewidth}\textbf{GenRocket} \par ~~ { \footnotesize
                ``Automated Data Delivery in Any Volume, Variety, and Format'' }
            \end{minipage}
        \item[{\includegraphics[width=2em,height=2em]{image/delphix.png}}]
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item az adatbázis kis tárhelyigénnyel fut
...
\begin{frame}
    ...
    %TODO: TreeRandom: könnyebben emészthető, kevesebb szöveg, +ábra, pl: egyenlő példány -> egyenlő kimenet [???]
...
\begin{frame}
    ...
    %TODO: Csak-olvasható réteg: ide még valami?
...
\begin{frame}
    ...
    %TODO: Kétfázisú értékkiosztás: adatlekérés: a szöveget is változtatni
...
\begin{frame}
    ...
    %TODO: Kétfázisú értékkiosztás: keresés: a szöveget is változtatni
