...
számára elérhető saját izolált adatbázist bocsátanak rendelkezésre,
...
hogy az épp aktuális tervállapot gombnyomásra teljeskörű adatbázisként elinduljon.
...
\begin{tabular}{ |p{3.2cm}|c c c c c:c c| }
  ...
  \hline
\end{tabular}
\caption[Adatmockolási módszerek összehasonlítása]{
...
\begin{figure}[H]
  ...
  \caption[Permutációk kimeneteinek összehasonlítása]{
    A \texttt{Permutation} különféle implementációinak kiemenetei \\
...
Ehhez elegendő a megfelelő JDBC connection stringet megadni,
