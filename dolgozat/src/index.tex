...
Végül a szerver rendkívül kis memóriaigénnyel fut\footnote{
    Ami persze a betöltött plusz adatforrások és a beérkező írási műveletek arányában megnövekedhet.
},
...
\begin{itemize}
  ...
  \item \textbf{Jelszó-hash:}
    ...
    pusztán formai elvárás esetén akár magára a seedre,
...
\begin{center}
  ...
  \begin{picture}(12,6)(0,0)
    ...
    \colorbox{gray!20}{\framebox(12,6){[TODO] Ábra: egyszerű konfiguráció és eredménye}}
  \end{picture}
\end{center}
...
\todo[inline]{Teljesítményteszt eredménye három megközelítéssel}

\begin{center}
  \setlength{\unitlength}{1cm}
  \begin{picture}(12,6)(0,0)
    \setlength\fboxsep{0pt}
    \colorbox{gray!20}{\framebox(12,6){[TODO] Ábra: Teljesítményteszt eredménye három megközelítéssel}}
  \end{picture}
\end{center}
