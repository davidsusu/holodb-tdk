...
\todo[inline,color=red]{Körvonalazás/Motiváció: bevezetés, mi lesz ebben a szekcióban}

\subsection{Egy mindennapi probléma}

\todo[inline,color=red]{Egy mindennapi probléma: A visszatérő probléma kifejtése, ami engem motivált}
