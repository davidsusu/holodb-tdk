...
mely tetszőleges \texttt{Table} implementáció fölé elhelyezhető.
...
\todo[inline]{docker; Serverless/lambda}
...
így a fájl strukturális és tartalmi helyessége statikusan ellenőrizhező.
...
\todo[inline]{Kép: baloldalt egyszerű config, jobboldalt entity diagram + data}
...
különféle tesztesetekhez finomhangolhatjuk az adatbázist.

A konfiguráció gépileg is generálható.
A prototípus tartalmaz néhány ilyen segédeszközt,
ezek közül a legfontosabb a konfigurációt a meglévő adatbázist letapogatásával,
...
kizárólag a konfigurációs fájlok különbségére épülő automatizálását.
...
demonstrálva a koncepció bővíthetőségét és rugalmasságát.
...
A wildcardot tartalmazó lekérdezéseknél többféle stratégiát követhetünk,
...
\todo[inline]{developer mode: on-the-fly újratöltés (config fájl vagy jpa)}
