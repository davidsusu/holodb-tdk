...
A szoftverfejlesztési és -release-elési folyamatok fontos előfeltevése,
hogy az alkalmazás mint absztrakt entitás snapshot jellegű,
azaz a mindenkori forráskód (és függőségek) aktuális \textit{állapotának} derviátuma,
...
\begin{itemize}
    ...
    \item integrációs és egy tesztek
    \item gyors prototípusgyártás, draft adatbázisok
    \item rövid demonstrációk, prezentációk
    \item \todo[inline]{sziuációk/normál lista befejezése}
\end{itemize}

De a listát kiegészíthetjük még egészen más jellegű szituációkkal is:

\begin{itemize}
    \item adatbáziskezelés oktatása
    \item \todo[inline]{sziuációk/egyéb lista befejezése}
\end{itemize}
...
\todo[inline,color=red]{Fakerek: A fakerek népszerűsége stb. (végül még valós adatgenerálásra is ezt használják)}
