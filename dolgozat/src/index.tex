...
azaz a mindenkori forráskód\footnote{
    Hozzáértve természetesen mindazokat a determinisztikus függőségeket is, amelyeket deklarál.
}
...
ahol ezek a költségek igencsak nemkívánatosak.
Ilyenek jellemzően:
...
De a listát kiegészíthetjük még egészen más jellegű szituációkkal is, találomra néhány:

\begin{itemize}
    \item adatbáziskezelés oktatása
    \item csak-olvasható adatbázisok loadbalance-olása
    \item 
\end{itemize}

[mégis adatbázissal csinálják, tárhelyigény, replikálás, anonimizálás vagy generálás stb.]



[a szoftver snapshot-két deployolható (verziókezelhetővé is ez teszi --> git)]
[az adatbázis belerondít ebbe a világba, élesben folyamatos evolúciója van, függetlenül a fejlesztéstől, +migrációs szkriptek stb.]
[már megfogalmazás: az éles adatok kedvéért minden oké, de nem akarjuk ezt a tesztelésbe stb. bevinni...]
[számtalan egyéb problémát is hoz, nagy stb.]
[mockolás/fejlesztés; tesztelés; kísérletezés/db-tervezés; demonstrálás; oktatás; anonimizálás; adatbázis-dokumentáció]
[hogyan kerüljük ki, hogy ezeket a problémákat meg kelljen örökölni?]

\todo[inline]{kinyitni a konf. fájl mint migrációs diff alap lehetőségét?}

\section{Ihletforrások}

\subsection{A kérések mockolása}

\todo[inline,color=red]{A kérések mockolása: on-the-fly, inkonzisztencia stb.}

\subsection{Adatgenerálás}

\longcomment{Adatgenerálás}{
A fakerek népszerűsége stb. (végül még valós adatgenerálásra is ezt használják);
generálás, on-demand generálás (elég limitált, és az aggregációkat szükségszerűen nem támogatja);
példákat hozni!
}

\subsection{Seed alapú nyílt világok}

\todo[inline,color=red]{Seed alapú nyílt világok: Mi ez? Miért ne használhatnánk adatbázisokhoz? Indexek, egyéb követelmények --> következő szekció}

\subsection{Valós relációs adatbázisok}

\todo[inline,color=red]{Valós relációs adatbázisok: Miben is áll egy valós adatbázis? Mi a szűk keresztmetszet}

\section{A megoldás körvonalai}
