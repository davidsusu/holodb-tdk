...
Természetesen ezek az esszenciális típusok apró szeletei csak a teljes architektúrának.
...
A további bitek ennek derivátumai, ennek legegyszerűbb algoritmusa,
...
Ezek mindegyikének keresőmetódusai egy \texttt{TableSelection} példánnyal térnek vissza,
melyen keresztül a találati listához férünk hozzá.

A következő osztálydiagramon ezeket az interfészekez foglaltam össze,
