...
A következő táblázat összehasonlítja megközelítésim és a már említett megoldások fő jellemzőit:
...
\begin{tabular}{ |p{3.2cm}|c c c c c:c c| }
  ...
  \parbox{\comptableleftwidth}{\rhpad Runtime \\ performancia \rhpad} &
    ...
    ((GGG)) \\
  \comptablelinesep
  \parbox{\comptableleftwidth}{\rhpad Prod. adatbázis \\ leképezése \rhpad} &
    ((AAA)) &
    ((BBB)) &
    ((CCC)) &
    ((DDD)) &
    ...
    ((GGG)) \\
  \comptablelinesep
  \parbox{\comptableleftwidth}{\rhpad Kérések közötti \\ konzisztencia \rhpad} &
    ((AAA)) &
    ((BBB)) &
    ((CCC)) &
    ((DDD)) &
  ...
  \parbox{\comptableleftwidth}{\rhpad Írható \rhpad} &
    ...
    \comptableicon{Green}{\faCheck} \\
  \comptablelinesep
  \parbox{\comptableleftwidth}{\rhpad Konfiguráció \rhpad} &
    ((AAA)) &
    ((BBB)) &
    ((CCC)) &
    ((DDD)) &
    ...
    ((GGG)) \\
  \comptablelinesep
  \parbox{\comptableleftwidth}{\rhpad Indítható \\ ORM alapján \rhpad} &
    \comptableicon{Apricot}{\faClose} &
    \comptableicon{Apricot}{\faClose} &
    \comptableicon{Apricot}{\faClose} &
    \comptableicon{Apricot}{\faClose} &
    \comptableicon{Apricot}{\faClose} &
    ...
    \comptableicon{Green}{\faCheck} \\
  \comptablelinesep
  \parbox{\comptableleftwidth}{\rhpad Sklázhatóság \rhpad} &
    ((AAA)) &
    ((BBB)) &
    ((CCC)) &
    ((DDD)) &
