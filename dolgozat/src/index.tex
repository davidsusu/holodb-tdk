...
Gyorsan számítható invertálható permutációk tipikus képviselője a modulo szorzásra épül.
...
\subsubsection{A \texttt{LargeInteger} típus}
...
\subsubsection{A \texttt{Permutation} és implementációi}
...
\subsubsection{A \texttt{Monotonic} és implementációi}
...
\subsubsection{A \texttt{TreeRandom} és kapcsolódó API-k}
