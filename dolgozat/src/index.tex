...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \legend{MariaDB gen.,MariaDB anon.,HoloDB}
        \end{axis}
    \end{tikzpicture}
    \caption[Futási idők összehasonlítása]{
        A különböző megközelítések futási idejének összehasonlítása
    }
\end{figure}

A generálásos és anonimizálásos módszerhez is MariaDB adatbázist használtam.
A generálási folyamatot egy python szkripttel vezéreltem,
...
kényelmesen verziókezelhető, generálható, előfeldolgoztható.
...
A bevett online felületeken túl (GitHub, Stackoverflow, BetaPage stb.)
