...
Az $f_i$ előfordulási gyakoriság szimulható is Zipf törvényére alapozva[hiv!].
...
Egy másik probléma (hacsaknem épp ez a cél), hogy a szövegek túl uniformak, ugyanannyi féle szóból állnak.
...
Egy harmadik egyszerű javítás a használati esetekre alapozható.
Ha előre ismert, hogy mely néhány (ideálisan kb. 6-8) szó lesz gyakran keresve,
akkor ezeket kiemelhetjük az előbbi szóhalmazból, és teljesen külön kezelhetjük.
Képezzük az összes lehetséges előfordulási kombinációt azok pontos gyakoriságával,
...
A mező szavainak összeállításához a kétféle kiosztás unióját kell venni,
...
\begin{enumerate}
    ...
    \item Helyezzünk ezek közé további szavakat a gyakoriságok figyelembevételével,
          míg a $c_i$ szószámot el nem érjük.
    \item Határozzuk meg a mondat- illetve részmondathatárok pozícióit.
    \item Fűzzük össze a szöveget szóközökkel.
          A mondatkezdő szavakat nagy kezdőbetűsre alakítjuk,
          a mondat- illetve részmondatvégekre pedig megfelelő központozást helyezünk el.
\end{enumerate}

Mindegyik lépés finomítható különféle heurisztikákkal.
Ennek lehetséges megoldásaival most nem foglalkozom.

A fent tárgyalt full-text index természetes módon továbbbővíthető különféle irányokba.
Könnyen integrálható például az exkuzálandó szavak listájának kezelése.
