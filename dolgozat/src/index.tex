...
hogy létező adatbázispéldányokon tanított mesterséges intelligencia segítségével is generálható.\footnote{
    Ígéretes, hogy mindössze egy példafájl és néhány instrukció után a ChatGPT-4 is meglehetősen jó eredményt generál.
}
...
\begin{itemize}
  \item \textbf{Egyszerű szöveg:}
    ...
    Markov-láncokra épülő egyszerűbb nyelvi modelleket)
