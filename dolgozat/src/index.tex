...
számuk egyszerű alakzatok esetén a mérettel egyenesen arányos.
...
A legalátalánosabb eset képletszerű összefüggések felsorolása lenne,
...
Ha lehetséges, hogy egyes seed értékek mellett a követelményrendszer nem kielégíthatő,
...
Szintén elég általános eset, amikor opcionálisan indexelt mesteroszlopok
alapján akarunk indexeletlen oszlopokat egymástól függetlenül legenerálni.
Ekkor teljes szabadságunk van,
értelemszerűen mesteroszlopok értékei és a \texttt{TreeRandom}-ból nyert seed lesz a bemenet.

Életszerű azonban, hogy a függő oszlopokra is szeretnénk indexelést.
...
Ekkor a többtáblára bontottság csak külsődleges,
