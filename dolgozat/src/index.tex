...
\begin{center}
  ...
  \begin{picture}(12,9)(0,0)
    ...
    \colorbox{gray!20}{\framebox(12,9){
        Ábra: Teljesítményteszt eredménye három megközelítéssel
    }}
  \end{picture}
\end{center}
...
a HoloDB valóban lényegesen jobban teljesít, mint a létező megoldások.

\subsection{Tervek a közeljövőre}
...
Ebbe a logikus, könnyen érthető, lényegretörő konfiguráció éppúgy beletartozik,
...
(generálás/materializálás, további REPL-funckiók, telepítőcsomagok, webes API-k stb.).
